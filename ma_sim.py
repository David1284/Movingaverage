...
def run():
    pairname = "AUD_USD"
    granularity = "H1"
    ma_short = [4,5,8,13,16, 32, 64, 100, 50, 150]
    ma_long = [6,8,10,13,16,32, 64, 96, 128, 256, 120,150, 200]
    ...
    print("\nBased on the Comprehensive backtest above, the best combination "
          "for " +str(pairname) +" is " +str(b_mashort) + " and " + str(b_malong) +" MA'S")
